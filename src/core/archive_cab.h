// ============================================================================
// archive_cab.h - CAB 格式驱动
//
// 基于 Windows Cabinet SDK（FDI/FCI）实现 CAB 格式的读写。
// CAB 是 Microsoft Cabinet 格式，常用于 Windows 安装包。
//
...
class CabArchive : public IArchive {
public:
    CabArchive();
    ~CabArchive() override;

    ArchiveFormat format() const override { return ArchiveFormat::Cab; }
